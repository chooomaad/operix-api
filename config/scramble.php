...
return [
    ...
    'info' => [
        ...
        'description' => "# Operix HSSE API\n\nAPI REST multi-tenant pour la plateforme **Operix HSSE**.\n\n## Authentification\nToutes les routes protégées requièrent un token Sanctum via `Authorization: Bearer {token}`.\n\n## Multi-tenant\nChaque requête authentifiée est automatiquement filtrée par le tenant de l'utilisateur connecté.\n\n## Versioning\nCette documentation couvre la version `/api/v1/`.",
    ],

    'ui' => [
        'title' => 'Operix HSSE — API Documentation',
    ],
